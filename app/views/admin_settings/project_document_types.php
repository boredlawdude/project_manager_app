...
<table class="table table-bordered align-middle bg-white">
    ...
    <tbody>
        <?php foreach ($types as $type): ?>
            <tr>
                <form method="post" action="/index.php?page=admin_document_types_update">
                    <input type="hidden" name="document_type_id" value="<?= (int)$type['document_type_id'] ?>">
                    <td><?= (int)$type['document_type_id'] ?></td>
                ...
                <form method="post" action="/index.php?page=admin_document_types_delete" style="display:inline">
                    <input type="hidden" name="document_type_id" value="<?= (int)$type['document_type_id'] ?>">
        ...
        <?php endforeach; ?>
        <tr>
            <form method="post" action="/index.php?page=admin_document_types_store">
                <td></td>
